...
-(id)initWithCoords:(CGPoint)pos appVO:(DIApp *)app {
	if ((self = [super initWithFrame:CGRectMake(pos.x, pos.y, 300.0, 60.0)])) {
		...
		EGOImageView *icoImgView = [[EGOImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, 60, 60)];
		...
		UILabel *appTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(66.0, 5.0, 180.0, 22)];
		...
		UILabel *infoLabel = [[UILabel alloc] initWithFrame:CGRectMake(66.0, 23.0, 300.0, 16)];
		...
		DIAppRatingStarsView *appRatingStarsView = [[DIAppRatingStarsView alloc] initWithCoords:CGPointMake(66.0, 38.0) appScore:_app.score];
