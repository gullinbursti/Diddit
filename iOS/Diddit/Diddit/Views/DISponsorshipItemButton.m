...
@implementation DISponsorshipItemButton
...
-(id)initWithSponsorship:(DISponsorship *)sponsorship AtIndex:(int)ind {
	if ((self = [super initWithFrame:CGRectMake(0, 0, 149.0, 94.0)])) {
		...
		_imgView.imageURL = [NSURL URLWithString:sponsorship.img_url];
...
-(void)_goTouchUp {
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:@"PUSH_SPONSORSHIP" object:[NSNumber numberWithInt:_ind]];
}
