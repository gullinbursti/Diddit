...
- (void)loadView {
	...
	[masterSignupButton setTitle:@"Instant" forState:UIControlStateNormal];
	[masterSignupButton addTarget:self action:@selector(_goInstantReward) forControlEvents:UIControlEventTouchUpInside];
	...
	[subSignupButton setTitle:@"Chore" forState:UIControlStateNormal];
	[subSignupButton addTarget:self action:@selector(_goChoreReward) forControlEvents:UIControlEventTouchUpInside];
